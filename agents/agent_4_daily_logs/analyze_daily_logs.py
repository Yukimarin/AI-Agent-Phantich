                            ...
                            if is_wildcard and worklane_projects:
                                ...
                                for proj in worklane_projects:
                                    ...
                                    for iss in issues_list:
                                        ...
                                        iss_assignee = iss.get('assignee', '').lower()
                                        
                                        # Check if assigned to this person and title matches
                                        if (norm_name in iss_assignee or m.lower() in iss_assignee):
