...
def main():
    ...
    res = subprocess.run([sys.executable, "agents/core/agent_1_class_kpi/calculate_kpi_json.py"], capture_output=True, text=True, encoding="utf-8")
    print(res.stdout)
    if res.returncode != 0:
    ...
    res = subprocess.run([sys.executable, "agents/core/agent_1_class_kpi/generate_kpi_report.py"], capture_output=True, text=True, encoding="utf-8")
    print(res.stdout)
    if res.returncode != 0:
    ...
    res = subprocess.run([sys.executable, "agents/core/agent_1_class_kpi/generate_report.py"], capture_output=True, text=True, encoding="utf-8")
    print(res.stdout)
    if res.returncode != 0:
