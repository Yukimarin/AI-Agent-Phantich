...
def parse_kpi_report():
    kpi_list = []
    filepath = "output/reports/report_kpi_gv_tg.md"
    if not os.path.exists(filepath):
...
def main():
    output_path = "output/dashboards/5_master_evaluation_dashboard.html"

    print("Trích xuất và biên dịch SPA Dashboard Native không dùng Iframe...")

    # Trích xuất nội dung các tab con
    body_a1, style_a1, js_a1 = extract_body_style_and_js("output/dashboards/1_kpi_report.html", "#tab-agent1-container")
    body_a2, style_a2, js_a2 = extract_body_style_and_js("output/dashboards/2_class_predictions_dashboard.html", "#tab-agent2-pred-container")
    body_a3, style_a3, js_a3 = extract_body_style_and_js("output/dashboards/3_gvtg_violations_report.html", "#tab-agent3-container")
    body_a4, style_a4, js_a4 = extract_body_style_and_js("output/dashboards/4_daily_logs_report.html", "#tab-agent4-container")
        ...
        <div id="tab-kpi-container" class="spa-tab-content transition-opacity duration-300">
            ...
            <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-sm">
                <div class="flex items-center justify-between flex-wrap gap-4">
                    ...
                    <a href="output/reports/report_kpi_gv_tg.md" target="_blank" class="px-4 py-2.5 bg-slate-100 hover:bg-slate-250 dark:bg-slate-800 dark:hover:bg-slate-700 text-xs font-bold rounded-xl transition-all shadow-sm">
