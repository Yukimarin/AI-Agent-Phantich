...
with open("output/reports/report_agent1.md", "r", encoding="utf-8") as f:
    md_content = f.read()
...
with open("output/dashboards/1_kpi_report.html", "w", encoding="utf-8") as f:
    f.write(final_html)

print("Agent 1: Báo cáo đã được xuất ra HTML thành công tại output\\1_kpi_report.html")
