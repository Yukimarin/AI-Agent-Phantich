...
def main():
    print("Agent 3: Khởi chạy trình sinh báo cáo HTML trực quan (generate_agent3_report)...")
    
    md_path = "data/vi_pham_gvtg_khoa_ks25.md"
    output_path = "output/3_gvtg_violations_report.html"
